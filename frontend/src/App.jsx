...
function App() {
  const [resumeData, setResumeData] = useState({
    ...
    projects: [],
    skills: '',
    languages: '', // <--- MAKE SURE THIS EXISTS
    certifications: [],
    awards: [],
    interests: '',
    volunteer: [],
  ...
  // --- THE FIX: ENSURE THIS FUNCTION EXISTS ---
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 bg-slate-50 px-3 py-2 rounded-lg border border-slate-200">
              ...
              <select value={selectedTemplate} onChange={(e) => setSelectedTemplate(e.target.value)} className="bg-transparent text-sm font-medium outline-none cursor-pointer text-slate-700">
